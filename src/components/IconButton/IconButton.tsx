...
const StyledButton = styled.button<StyledButtonProps>`
  ...
  background-color: ${(props) =>
    !props.disabled ? props.theme.color.mainColor : props.theme.color.textTertiary};
  border: 0;
  border-radius: 28px;
  ...
  &:hover {
    background-color: ${(props) =>
      !props.disabled ? props.theme.color.mainColorHover : props.theme.color.textTertiary};
  }
`;
