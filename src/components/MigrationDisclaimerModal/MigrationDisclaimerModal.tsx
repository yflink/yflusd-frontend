...
const MigrationDisclaimerModal: React.FC<MigrationDisclaimerModalProps> = ({
  onConfirm,
  onDismiss,
}) => {
  ...
  return (
    <Modal>
      ...
      <div>
        <StyledText>
          Due to the upgrade, all Boardroom functionalities other than [Claim and withdraw] has
